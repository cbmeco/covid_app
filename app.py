...
hosp_rate = (
    st.sidebar.number_input("Hospitalization % or Infected Rate at 100%", 0, 100, value=5, step=1, format="%i")
    / 100.0
)
#icu_rate = (
...
Penn_market_share = (
    st.sidebar.number_input(
        "Comcast EEs + Dependents as Share of Regional Pop (%)", 0.000, 100.000, value=1.000, step=0.001, format="%f"
    )
    / 100.0
)
...
if st.checkbox("Show more info about this tool & Population Options"):
    ...
    st.markdown("""NYC Area: Known Infections (as of 3/16): 329, Comcast Pop: .002%, Regional Pop: 8500000""")    
...
st.markdown("Projected number of **daily** COVID-19 admissions of Comcast Mbrs in area hospitals")
...
st.markdown(
    "Projected **census** of COVID-19 patients, accounting for arrivals and discharges at Area hospitals"
)
